...
class Sections extends Admin_Controller {
 ...
 function getSubjects(){
    ...
    function getClassSectionSubjects(){
        ...
        $data = $this->section_model->getClassSubjects($class_id,$section_id);
        echo json_encode($data);
    }
        function getClassTeacherSubjects(){
    ...
    function getClassTeacherSection() {
        ...
        if (($userdata["role_id"] == 2 OR $userdata["role_id"] == 15 OR $userdata["role_id"] == 16 OR $userdata["role_id"] == 19) && ($userdata["class_teacher"] == "yes")) {
            $id = $userdata["id"];
