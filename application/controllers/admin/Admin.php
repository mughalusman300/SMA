...
class Admin extends Admin_Controller {
    ...
    function dashboard() {
        ...
        $getDepositeAmount = 0;//$this->studentfeemaster_model->getDepositAmountBetweenDate($year_str_month, $year_end_month);

        //======================Current Month Collection ==============================
        $first_day_this_month = date('Y-m-01');

        $month_collection = 0;//$this->whatever($getDepositeAmount, $first_day_this_month, $current_date);
