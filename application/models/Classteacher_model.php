...
public function CheckClassTeacher($class_id = null, $section_id = null, $teacher = null) {




            $query = $this->db->select(",class_teacher.id")
            ->where("class_teacher.class_id", $class_id)
            //->where("class_teacher.full_attendence", '1')
            ->where("class_teacher.section_id", $section_id)
            ->where("class_teacher.staff_id", $teacher)
            ->get("class_teacher");
    ...
    */
    //getclassbyuser by me 
    public function getclassbyuser($id) {


        $query = $this->db->select("classes.*")
