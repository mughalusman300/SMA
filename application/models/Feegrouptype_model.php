...
class Feegrouptype_model extends CI_Model {
    ...
    public function remove($id) {
        ...
        if ($num_rows == 1) {
            ...
            $this->db->update('fee_session_groups',array("is_active"=>'no'));
        ...
        $this->db->update('fee_groups_feetype',array("is_active"=>'no'));
    ...
    public function active($id) {
        ...
        if ($num_rows == 1) {
            ...
            //$this->db->delete('fee_session_groups');
            $this->db->update('fee_session_groups',array("is_active"=>'yes'));
        ...
        //$this->db->delete('fee_groups_feetype');
        $this->db->update('fee_groups_feetype',array("is_active"=>'yes'));
