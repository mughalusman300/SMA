            ...
            <?php if ($this->session->has_userdata('success')) { ?>
                ...
                <div class="box box-info">
                    <div class="box-body table-responsive">
                        <div >
                            <table class="table table-hover table-striped table-bordered withoutPagination">
                                <thead>
                                    <tr>
                                ...
                                <?php $i=0; foreach ($orders as $p) { ?>
                                        <tr>
                                           ...
                                           <td class="mailbox-name"><?php echo $p['guardian_id'] ?></td> 
                                            ...
                                            <a href="<?php echo base_url(); ?>admin/BookStore/generateinvoice/<?php echo $p['order_id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="Generate Invoice">
