            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('search_income'); ?></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" id="action_form" action="<?php echo site_url('admin/transaction/searchincome') ?>" method="get" class="form-horizontal">
                        ...
                        <div class="nav-tabs-custom">    
                            <ul class="nav nav-tabs pull-right">
                                ...
                                if ($this->module_lib->hasActive('income')) {
                                    ?>                      
                                    <li  class="active"><a href="#tab_income" data-toggle="tab"><?php echo $this->lang->line('income_details'); ?></a></li>
                                <?php } ?>   
                                         
                            </ul>
                            <div class="box-body table-responsive">     
                                <div class="tab-content">
                                    <div class="tab-pane table-responsive active" id="tab_income">  
