                                        ...
                                        foreach ($examSchedule as $exam) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                    ...
                                                    <a  class="btn btn-primary btn-sm copy_exam_to_all_section" data-toggle="tooltip" title="" data-examname="<?php echo $exam['name']; ?>" data-examid="<?php echo $exam['exam_id']; ?>" data-original-title="<?php echo $this->lang->line('view_detail'); ?>" data-sectionid='<?php echo $section_id ?>' data-classid='<?php echo $class_id ?>' data-classname="<?php echo $exam['class_name'] ?>"  data-sectionname="<?php echo $exam['section_name'] ?>">

                                                        <i class="fa fa-copy"></i> <?php echo $this->lang->line('copy_exam_to_all_section'); ?>
...
<script type="text/javascript">
 ...
 $(document).on('click', '.copy_exam_to_all_section', function () {
        ...
        var base_url = '<?php echo base_url() ?>';
        if(confirm("Are you sure to copy exam to all the section of class "+classname+" ?")){
        $.ajax({

            type: "post",

            url: base_url + "admin/examschedule/copyexamtoallsection",
            ...
            success: function (response) {
                if(response.status){
                    alert("You have successfully copied the exam schedule on all section");
                }
                else{
                    alert("Error occured while coping the exam schedule, Please try again or contact to administrator.");
                }
            }
        });
        }
