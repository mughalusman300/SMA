                                                            ...
                                                            foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                                ...
                                                                <tr class="mailbox-name">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php echo $feetype_value_code = $feetype_value->code; ?>
                                                            ...
                                                            foreach ($resultlist as $student) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> 
                                                                        ...
                                                                        <input type="hidden" name="student_admission_no[]" value="<?php echo $student['admission_no']; ?>">
                                                                        <input type="hidden" name="student_discount_id[<?php echo $student['student_session_id'];?>]" value="<?php echo (trim($feetype_value_code == 'TUITION')?$student['discount_id']:0); ?>">
