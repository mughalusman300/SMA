...
<div class="content-wrapper" style="min-height: 946px;">   
    <section class="content-header">
        <h1>
            <i class="fa fa-money"></i> Student Fee Discounts</h1>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" id="action_form" action="<?php echo site_url('admin/feemaster/studentDiscountCodes') ?>" method="post" class="form-horizontal">
                                                        ...
                                                        if (empty($resultlist)) {
                                                            ...
                                                            foreach ($resultlist as $student) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $student['discount_code']." ".$student['discount_amount']."%"; ?></td>
