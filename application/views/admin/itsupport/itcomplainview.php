...
<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php if ($this->rbac->hasPrivilege('maintenance_task', 'can_add')) { ?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/itcomplain') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
            ...
            if ($this->rbac->hasPrivilege('maintenance_task', 'can_add')) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right" "="">
                                                    ...
                                                    <?php if ($this->rbac->hasPrivilege('maintenance_task', 'can_edit')) { ?>    
                                                        ...
                                                        <a href="<?php echo base_url(); ?>admin/itcomplain/edit/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Edit">
                                                    ...
                                                    <?php if ($this->rbac->hasPrivilege('maintenance_task', 'can_delete')) { ?>

                                                        <?php if ($value['image'] !== "") { ?><a href="<?php echo base_url(); ?>admin/itcomplain/imagedelete/<?php echo $value['id']; ?>/<?php echo $value['image']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="Delete">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>admin/itcomplain/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="Delete">
