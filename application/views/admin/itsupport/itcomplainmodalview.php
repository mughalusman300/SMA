<table class="table table-striped bordergray">
    ...
    <tr>
        ...
        <td><?php print_r(  "MR-".$complaint_data['id']); ?></td>
    ...
    <tr>
        ...
        <td><?php print_r($complaint_data['status']); ?></td>
        <th><?php echo $this->lang->line('completion_date '); ?></th>
         
        
        <td>
         <?php if (($complaint_data['status'])=="Completed"){?>
            <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($complaint_data['completion_date'])) ?>
         <?php } ?>
        </td>
    </tr>
</tbody>
