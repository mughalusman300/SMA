                ...
                <div class="box box-primary">
                 ...
                 <!--input autofocus="" name="account_type" class="ac_type" id="input-type-student" value="<?php echo $role_value['id']; ?>" type="radio" /-->
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input id="issue_date" name="issue_date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('issue_date', date($this->customlib->getSchoolDateFormat()) ); ?>" readonly />
...
<script type="text/javascript">
...

    {
        ...
        data.push({id: 'issue_to', value: issue_to});
