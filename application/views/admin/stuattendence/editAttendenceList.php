        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stuattendence/Edit') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select  id="" name="section_id" class="form-control" >
                                                    ...
                                                    foreach ($classSection as $class) {
                                                        ...
                                                        ?>
                                                        <option 
                                                                value="<?php echo $class['section_id']; ?>" <?php
                                                        if ($section_id == $class['section_id']) {
                                                            echo "selected =selected";
                                                        }
                                ...
                                <div id="select_criteria_3" <?php if($searchBySubject){ echo 'class="col-md-3"';}else{ echo 'class="col-md-4"';} ?>>
                                    <div class="form-group">
                                        ...
                                        <input id="date" name="date" placeholder="" type="text" class="form-control"<?php if(!empty($date)) 
                                         { ?> value="<?php  echo $date ; ?>" <?php } ?>
                                         value="<?php  echo $att_date ; ?>"  readonly="readonly"/>
                                        
                                        <!--value="<?php if(date('D')!="Tue" OR date('D')!="Mon") { echo set_value('date', date($this->customlib->getSchoolDateFormat()));} ?>"-->
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($resultlist)) {
                                ...
                                ?>
                                <form action="<?php echo site_url('admin/stuattendence/Edit') ?>" method="post">
                                    <?php echo $this->customlib->getCSRF(); ?>
