                    ...
                    <form id='form1' action="<?php echo site_url('admin/stuattendence/classattendencereport') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div id="section_container" <?php if($searchBySubject){ echo 'class="col-md-3"';}else{ echo 'class="col-md-3"';} ?>>
                                    <div class="form-group">
                                ...
                                <div id="subject_container" class="col-md-2" <?php if(!$searchBySubject){ echo 'style="display:none"';} ?> >
                                    <div class="form-group">
                                ...
                                <div id="startdate_container"<?php if($searchBySubject){ echo 'class="col-md-2"';}else{ echo 'class="col-md-3"';} ?>>
                                 <div class="form-group">
                                   <label>Start Date</label>
                                   <input type="date" name="start_date" id="start_date" class="form-control date" placeholder="Search by Date" data-form="datepicker" value="<?php if (isset($start_date)) echo $start_date?>" />
                                   <span class="text-danger"><?php echo form_error('start_date'); ?></span>
                                 </div>
                               </div>

                               <div id="enddate_container" <?php if($searchBySubject){ echo 'class="col-md-2"';}else{ echo 'class="col-md-3"';} ?>>
                                 <div class="form-group">
                                   <label>End Date</label>
                                   <input type="date" data-form="datepicker" name="end_date" id="end_date" onchange="searchDate()" class="form-control date" placeholder="Search by Date" value="<?php if (isset($end_date)) echo $end_date?>"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="lateday">
                                            ...
                                            <b>Total School Days:<code><?php echo $total_working_days;?></code></b>
                                            <b>Days:D</b>
                                            <?php
                                    ...
                                    <table class="table table-striped table-bordered table-hover example xyz">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><span data-toggle="tooltip" title="<?php echo "Gross Present Percentage(%)"; ?>">%</span></th>

                                                <?php
                                                foreach ($attendencetypeslist as $key => $value) {
                                                    if (strip_tags($value["key_value"]) != "E") {
                                                        ?>
                                                        <th colspan="" ><span data-toggle="tooltip" title="<?php echo "Total " . $value["type"]; ?>">
                                                ...
                                                ?>
                                                <th><span data-toggle="tooltip" title="<?php echo "Total  Days"; ?>">D</span></th>
                                                <!--<?php
                                            ...
                                            <?php if (empty($student_array)) {
                                                ...
                                                foreach ($student_array as $student_key => $student_value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th> <?php echo $total_school_days;?></th>
            ...
            todayHighlight: true,
                    ...
                    $('#class_id').change(function(){
                        ...
                        if(attendanceType == '0'){
                            ...
                            $("#startdate_container").removeClass("col-md-2");
                            $("#enddate_container").removeClass("col-md-2");

                            $("#section_container").addClass("col-md-3");
                            $("#startdate_container").addClass("col-md-3");
                            $("#enddate_container").addClass("col-md-3");


                            $('#subject_container').hide();
                            $('#subject_select').prop('required', false);

                        }else{
                            $("#section_container").removeClass("col-md-3");
                            $("#startdate_container").removeClass("col-md-3");
                            $("#enddate_container").removeClass("col-md-3");

                            $("#section_container").addClass("col-md-3");
                            $("#startdate_container").addClass("col-md-2");
                            $("#enddate_container").addClass("col-md-2");
