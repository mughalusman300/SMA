        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stuattendence/fullattendance') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php
                            ...
                            <div class="row">
                                <div id="select_criteria_1" class="col-md-4">
                                        ...
                                        <select autofocus="" id="class_id" name="class_id" class="form-control" >
                                            ...
                                            foreach ($classlist as $class) {
                                                      $userdata = $this->customlib->getUserData();
                                                        if($class['full_attendence']== 1 && $userdata["role_id"] == 5 ){   
                                                        ?>
                                                        <option data-attendance_type="<?php echo $class['attendance_type']; ?>"
                                                                value="<?php echo $class['id']; ?>" <?php
                                                        if ($class_id == $class['id']) {
                                ...
                                <div id="select_criteria_2" class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div id="subject_container" class="col-md-3"  style="display:none">
                                    <div class="form-group">
                                ...
                                <div id="select_criteria_3" class="col-md-4">
                                    <div class="form-group">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($resultlist)) {
                                ...
                                ?>
                                <form action="<?php echo site_url('admin/stuattendence/fullattendance') ?>" method="post">
                                    <?php echo $this->customlib->getCSRF(); ?>
