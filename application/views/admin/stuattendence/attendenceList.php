            ...
            <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div id="select_criteria_3" <?php if($searchBySubject){ echo 'class="col-md-3"';}else{ echo 'class="col-md-4"';} ?>>
                                    <div class="form-group">
                                        ...
                                        <input id="date" name="date" placeholder="" type="text" class="form-control" <?php if (!empty($date)){ ?> value="<?php echo $date;?>"  <?php } ?> readonly="readonly"/>
                ...
                if (isset($resultlist)) {
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('attendance'); ?></h3>
