                           ...
                           <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('fee_status'); ?></th>
                                        <th><?php echo $this->lang->line('is_taxable'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($feetypeList as $feetype) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <?php
                                                    if ($feetype['is_active'] == "no") {
                                                        ?>
                                                <span class="btn btn-xs btn-danger"><?php echo $this->lang->line('deleted'); ?></span>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <span class="btn btn-xs btn-success"><?php echo $this->lang->line('active'); ?></span>
                                                        <?php
                                                    }
                                                    ?>
                                            </td>
                                            <td class="mailbox-name">
                                                <?php
                                                    echo $feetype['is_taxable'];
                                                    ?>
                                            </td>
                                            <td class="mailbox-name">
                                                <?php
                                                    echo $feetype['description'];
                                                    ?>
                                            </td>
                                            ...
                                            <td class="mailbox-date pull-right"">
                                                ...
                                                <?php } ?>
                                                <?php
                                                if ($this->rbac->hasPrivilege('fees_type', 'can_edit') && trim($feetype['is_active']) == 'no') {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/feetype/active/<?php echo $feetype['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('active'); ?>" onclick="return confirm('<?php echo $this->lang->line('active_confirm') ?>');">
                                                        <i class="fa fa-check"></i>
                                                    </a>
                                                <?php }
                                                if ($this->rbac->hasPrivilege('fees_type', 'can_delete') && trim($feetype['is_active']) == 'yes') {
                                                    ?>
