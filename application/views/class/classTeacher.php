                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/teacher/assign_class_teacher"  method="post" accept-charset="utf-8">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="class" id="class_id">
                                        ...
                                        foreach ($classlist as $class_key => $class_value) {
                                            ...
                                            <option data-attendance_type="<?php echo $class_value['attendance_type']; ?>" value="<?php echo $class_value["id"] ?>"><?php echo $class_value["class"] ?></option>
                                ...
                                <div class="form-group">
                                 ...
                                 <!--<div id="subject_container" class="form-group" <?php if(!$assignClassIfSubject){ echo 'style="display:none"';} ?> >
                                    
                                        <label for="exampleInputEmail1"><?php echo "Attendance Type"; ?></label><small class="req"> *</small>

                                        <select autofocus="" id="attendance" name="full_attendence" class="form-control" >
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <option value="1"><?php echo "Full Day" ?></option>
                                            <option value="0"><?php echo "Subject Wise" ?></option>

                                        </select>
                                        <span class="text-danger"><?php echo form_error('suject_id'); ?></span>
                                </div>-->
                                <div class="form-group">
                                    ...
                                    foreach ($assignteacherlist as $teacher) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                ...
                                                <?php if ($teacher['attendance_type']==1){
                                                    $type = "<code>(S)</code>";
                                                 }else{
                                                    $type ='';
                                                 }?>
                                                
                                                <?php echo $teacher["class"]." ".$type ?>
                                            ...
                                            <td>
                                                ...
                                                <?php foreach ($tlist[$i] as $key => $tsvalue) {
                                                    ...
                                                    <!--<?php if ($tsvalue['attendance_type']==1 && $tsvalue['full_attendence']== 1 ){
                                                    $type = '<code>(F)</code>';
                                                    }
                                                    else{
                                                    $type ="";
                                                ...
                                                <!--<?php foreach ($tlist[$i] as $key => $tsvalue) {
                                                    ...
                                                    <?php if($tsvalue["full_attendence"]=='1'){ 
                                                     $attendance_type = " (Full Day)";
                                                     echo $tsvalue["name"]." ". $tsvalue['surname']. $attendance_type. "<br/>"; 
                                                      } ?>
                                                      <?php if($tsvalue["full_attendence"]=='0'){ 
                                                     $attendance_type = " (Subject Wise)";
                                                     echo $tsvalue["name"] .$attendance_type. "<br/>"; 
                                                      } ?>
                                                    <input type="hidden"  name="teacherid[]" value="<?php echo $tsvalue["id"] ?>" >
