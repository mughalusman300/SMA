                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/teacher/update_class_teacher"  method="post" accept-charset="utf-8">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="class"  id="class_id" disabled="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="section_id" name="section" disabled="true">
    ...
    <?php foreach ($result as $result_key => $result_value) {
        ...
        ?>
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" id="submitform" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
