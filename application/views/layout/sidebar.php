...
///////////////////////////////// IT Support Menu Section Start/////////////////////////////////////

                        if ($this->module_lib->hasActive('it_support')) {
                        if (($this->rbac->hasPrivilege('maintenance_task', 'can_view')||
                             $this->rbac->hasPrivilege('maintenance_request', 'can_view')||
                             $this->rbac->hasPrivilege('setup_its', 'can_view')||
                             $this->rbac->hasPrivilege('complain_reporting', 'can_view'))) {
                                ?>
                                <li class="treeview <?php echo set_Topmenu('it_support'); ?>">
                                    <a href="#">
                                        <i class="fa fa-sitemap"></i> <span><?php echo $this->lang->line('it_support'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('maintenance_task', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('admin/itcomplain'); ?>"><a href="<?php echo base_url(); ?>admin/itcomplain"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('maintenance_task'); ?></a></li>
                                             <?php } ?>
                                             <?php 
                                        if ($this->rbac->hasPrivilege('maintenance_request', 'can_view')) {
                                            ?>

                                            <li class="<?php echo set_Submenu('admin/itcomplain/itComplainByUser'); ?>"><a href="<?php echo base_url(); ?>admin/itcomplain/itComplainByUser"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('maintenance_request'); ?></a></li>
                                             <?php } ?>
                                           <?php if ($this->rbac->hasPrivilege('setup_its', 'can_view')) { ?>

                                            <li class="<?php echo set_Submenu('admin/itcomplaintype'); ?>"><a href="<?php echo base_url(); ?>admin/itcomplaintype"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('setup_its'); ?></a></li>
                                            <?php } ?>
                                            <?php if ($this->rbac->hasPrivilege('its_report', 'can_view')) { ?>

                                            <li class="<?php echo set_Submenu('admin/itcomplain/itreports'); ?>"><a href="<?php echo base_url(); ?>admin/itcomplain/itreports"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('its_report'); ?></a></li>
                                            <?php } ?> 
    ...
    if ($this->rbac->hasPrivilege('book_store', 'can_view')) {
        ...
        <?php
                     ...
                     /*if ($this->module_lib->hasActive('receipts')) {
                        ...
                        if ($this->module_lib->hasActive('credit_notes')) {
                            if ( $this->rbac->hasPrivilege('credit_notes', 'can_view')) {
                                ?>
                                <li class="treeview <?php echo set_Topmenu('credit_notes'); ?>">
                                    <a href="#">
                                        <i class="fa fa-money"></i> <span> <?php echo $this->lang->line('credit_notes'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if ($this->rbac->hasPrivilege('credit_notes', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('admin/credit_notes/index'); ?>"><a href="<?php echo base_url(); ?>admin/credit_notes/index"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('credit_notes'); ?></a></li>
                                            <?php
                                        }
                                        ?>
                                    </ul>
                            ...
                            if (($this->rbac->hasPrivilege('student_attendance', 'can_view') ||
                             $this->rbac->hasPrivilege('student_attendance_report', 'can_view') ||
                              $this->rbac->hasPrivilege('attendance_report', 'can_view')||
                               $this->rbac->hasPrivilege('attendance_register', 'can_view'))) {
                                ?>
                                <li class="treeview <?php echo set_Topmenu('Attendance'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <?php } ?>
                                        <?php  if ($this->rbac->hasPrivilege('attendance_register', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('stuattendence/classmonthlyattendencereport'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/classmonthlyattendencereport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('attendance_register'); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                <?php
                        ...
                        if ($this->module_lib->hasActive('library')) {
                            if (($this->rbac->hasPrivilege('books', 'can_view') ||
                                 ...
                                 $this->rbac->hasPrivilege('issue_by_class', 'can_view') ||
                                 $this->rbac->hasPrivilege('return_by_class', 'can_view') ||
                                 $this->rbac->hasPrivilege('add_staff_member', 'can_view') ||
                                 $this->rbac->hasPrivilege('add_student', 'can_view')||
                                 $this->rbac->hasPrivilege('book_reports', 'can_view')||
                                 $this->rbac->hasPrivilege('book_issue_reports', 'can_view')||
                                 $this->rbac->hasPrivilege('fine_report', 'can_view')
                             )) {
                                ?>
                                <li class="treeview <?php echo set_Topmenu('Library'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <?php } ?>
                                        <?php  if ($this->rbac->hasPrivilege('issue_by_class', 'can_view')) 
                                        { ?>
                                            <li class="<?php echo set_Submenu('member/issue_by_class'); ?>"><a href="<?php echo base_url(); ?>admin/member/issuedBooksByclass"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('issue_by_class'); ?></a></li>
                                        <?php } ?>
                                    <?php  if ($this->rbac->hasPrivilege('return_by_class', 'can_view')) 
                                        { ?>
                                            <li class="<?php echo set_Submenu('member/return_by_class'); ?>"><a href="<?php echo base_url(); ?>admin/member/ReturnBooksByclass"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('return_by_class'); ?></a></li>
                                        <?php } ?>
                                        ...
                                        <?php } ?>
                                        <?php if ($this->rbac->hasPrivilege('book_reports', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('book/booksreport'); ?>"><a href="<?php echo base_url(); ?>admin/book/booksreport"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('book_reports'); ?></a></li>
                                        <?php } ?>
                                        <?php if ($this->rbac->hasPrivilege('book_issue_reports', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('book/booksissuereport'); ?>"><a href="<?php echo base_url(); ?>admin/Book/booksissuereport"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('book_issue_reports'); ?></a></li>
                                        <?php } ?>
                                        <?php if ($this->rbac->hasPrivilege('fine_report', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('book/finereport'); ?>"><a href="<?php echo base_url(); ?>admin/Book/finereport"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('fine_report'); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                <?php
...
<?php
                                       ...
                                       if ($this->rbac->hasPrivilege('transaction_report', 'can_view')) {
                                            ?>                               
                                            <li class="<?php echo set_Submenu('transaction/searchincome'); ?>"> <a href="<?php echo base_url(); ?>admin/transaction/searchincome"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('income_report'); ?></a></li>
                                       <?php }
                                       if ($this->rbac->hasPrivilege('transaction_report', 'can_view')) {
                                            ?>                               
                                            <li class="<?php echo set_Submenu('transaction/searchexpense'); ?>"> <a href="<?php echo base_url(); ?>admin/transaction/searchexpense"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('expense_report'); ?></a></li>
                                       <?php }
