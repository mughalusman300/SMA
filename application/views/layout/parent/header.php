        ...
        <div class="wrapper">
            <header class="main-header" id="alert">            
                <a href="<?php echo base_url(); ?>parent/parents/dashboard" class="logo">                   
                    ...
                    <span class="logo-lg"><img src="<?php echo base_url(); ?>backend/images/pic.png" alt="<?php echo $this->customlib->getAppName() ?>" /></span>
                </a>              
                <nav class="navbar navbar-static-top" role="navigation">                  
                    ...
                    <div class="col-md-7 col-sm-3 col-xs-7">     
                        <span href="#" class="sidebar-session">
                           <!---<?php echo $this->setting_model->getCurrentSchoolName(); ?>-->
							 International School  - English Section
                        </span>
                    </div>    
                    <div class="col-md-5 col-sm-9 col-xs-5">
