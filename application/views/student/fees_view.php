                                    ...
                                    <tbody>
                                        ...
                                        foreach ($student_due_fee as $key => $fee) {
                                            ...
                                            foreach ($fee->fees as $fee_key => $fee_value) {
                                                ...
                                                $total_discount_amount = $total_discount_amount + $fee_discount ;//$fee_discount;
                                                $total_deposite_amount = $total_deposite_amount + $fee_paid;
                                                $total_fine_amount = $total_fine_amount + $fee_fine;
                                                
                                                $fee_tax_amount = (($fee_tax["fee_tax"] * ($fee_value->amount - $fee_discount + $total_fine_amount)) / 100);
												$feetype_balance =  number_format(($fee_value->amount+$fee_tax_amount) - ($fee_paid + $fee_discount),2);
                                                $total_tax_amount = $total_tax_amount+ $fee_tax_amount;
                                              @  $total_balance_amount = $total_balance_amount + $feetype_balance;
                                                ...
                                                ?>
                                                    ...
                                                    <td class="text text-right"><?php
                                                        ...
                                                        ?></td>
                                                    <td class="text text-right"><?php
                                                        echo (number_format($fee_tax_amount , 2, '.', ''));
                                                        ?></td>
                                                    <td class="text text-right"><?php
                                                    ...
                                                    <td class="text text-right">
                                                        ...
                                                        if (@$feetype_balance > 0) {
                                                            $display_none = "";
                                                            echo @(number_format($feetype_balance+$fee_tax_amount, 2, '.', ''));
                                                        }
                                                        ?>
                                                    </td>
                                                    <td>
                                                ...
                                                if (!empty($fee_value->amount_detail)) {
                                                    $fee_deposits = json_decode(($fee_value->amount_detail));
                                                    foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                        if (trim(@$fee_deposits_value->status) == 'deleted') continue; ?>
                                        ...
                                        <tr class="box box-solid total-bg">
                                            ...
                                            <td class="text text-right"><?php
                                                ...
                                                ?></td>
                                            <td class="text text-right"><?php
                                                echo ($currency_symbol . number_format($total_balance_amount + $total_tax_amount, 2, '.', ''));
                                                ?></td>  
                                            <td class="text text-right"></td>
                                        </tr>
                                    </tbody>
