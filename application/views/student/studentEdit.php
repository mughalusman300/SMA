                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="name_arabic" value="<?php echo $student['passport_number']; ?>" name="passport_number" placeholder="" type="text" class="form-control"  value="<?php echo set_value('passport_number'); ?>" />
                                ...
                                <div class="around10">  
                                    <div class="row">
                                        <div class="col-md-3">
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('guardian_name_arabic'); ?></label>
                                                <input id="father_name" name="guardian_name_arabic" placeholder="" type="text" class="form-control"  value="<?php echo set_value('guardian_name_arabic', $student['guardian_name_arabic']); ?>" />
                                                <span class="text-danger"><?php echo form_error('guardian_name_arabic'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
