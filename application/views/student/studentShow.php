                                ...
                                <div class="table-responsive around10 pt10">
                                    <table class="table table-hover table-striped tmb0">
                                        <tr>
                                            ...
                                            <td rowspan="4"><img class="profile-user-img img-responsive img-circle" src="<?php if(!empty($student["father_pic"])){ echo base_url().$student["father_pic"]; }else{ echo base_url()."uploads/student_images/no_image.png"; } ?>" ></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><?php echo $this->lang->line('guardian_name_arabic'); ?></td>
                                            <td><?php echo $student['guardian_name_arabic']; ?></td>
                                        </tr>
                                        <tr>
...
$alot_fee_tax = 0;
    foreach ($student_due_fee as $key => $fee) {
        ...
        foreach ($fee->fees as $fee_key => $fee_value) {
            $fee_paid = 0;
            $fee_discount = (($discount_percent*$fee_value->amount)/100);
            $fee_fine = 0;
            $alot_fee_discount = 0;
            $amountPaidCheck = 0;
            ...
            $amountPayable = ($fee_value->amount - $fee_discount + $fee_fine);
            $taxPayable = (($fee_tax["fee_tax"]*$amountPayable )/100);
           $alot_fee_tax = $alot_fee_tax + $taxPayable;
                                                    
            $feetype_balance = number_format(($fee_value->amount+$taxPayable) - ($fee_paid + $fee_discount),2);
          @  $total_balance_amount = $total_balance_amount + $feetype_balance;
            ...
            ?>
                                                    ...
                                                    ?></td>
                                                        ...
                                                        if (@$feetype_balance > 0) {
                                                            $display_none = "";
                                                            echo @(number_format($feetype_balance+$taxPayable, 2, '.', ''));
                                                        }
                                                        ?></td>
    ...
    ?>
                                        ...
                                        ?></td>
                                                <td class="text text-right"><?php
                                                    ...
                                                    ?></td>
                                                <td class="text text-right"><?php
                                                echo ($currency_symbol . number_format($alot_fee_tax, 2, '.', ''));
                                                ?></td>
                                                <td class="text text-right"><?php
                                                ...
                                                <td class="text text-right"><?php
                                                echo @($currency_symbol . number_format($total_balance_amount +$alot_fee_tax  - $alot_fee_discount, 2, '.', ''));
                                                ?></td> 
