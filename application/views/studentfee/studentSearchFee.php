                                        ...
                                        foreach ($student_due_fee as $student) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text text-right"><?php
                                                    ...
                                                    ?></td>
                                                    <td class="text text-right"><?php
                                                    $amountPayableBeforeTax = ($student['amount'] - ($student['amount_detail'] + $student['amount_discount']));
                                                    echo $taxAmount = ($fee_tax["fee_tax"] * $amountPayableBeforeTax ) /100;

                                                    ?></td>
                                                <td class="text text-right"><?php
                                                    echo number_format(($amountPayableBeforeTax +$taxAmount), 2, '.', '');
