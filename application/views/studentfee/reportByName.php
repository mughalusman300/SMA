                                ...
                                <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                    ...
                                    <tbody>
                                            ...
                                            foreach ($fee->fees as $fee_key => $fee_value) {
                                                ...
                                                if (!empty($fee_value->amount_detail)) {
                                                    ...
                                                    foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                       ...
                                                       //$fee_discount = $fee_discount + (($discount_percent*$fee_value->amount)/100);
                                                ...
                                                if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                    ...
                                                    echo $taxPayable = (($fee_tax["fee_tax"]*$amountPayable )/100);
                                        ...
                                        <tr class="box box-solid total-bg">
                                            ...
                                            <td align="left"></td>
                                            <td class="text text-right"><?php
											$ctotal = $total_discount_amount + $alot_fee_discount;
                                                echo ($currency_symbol . number_format($ctotal, 2, '.', ''));
                                                ?></td>
                                            ...
                                            <td class="text text-right"><?php
                                                ...
                                                ?></td>
                                            <td class="text text-right"><?php
											echo $ctotalBalance = ($total_amount - $ctotal+$alot_fee_tax - $total_deposite_amount )
